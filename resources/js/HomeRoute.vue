...
<header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
        ...
        <h1 class="logo me-auto"><a href="#">Welcome</a></h1>
        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 mt-4" data-aos="zoom-in" data-aos-delay="400">
                    <div class="member d-flex align-items-start">
                        <div class="pic"><img src="https://i.ibb.co/vPYPF4v/image-20240410-144624.png" class="img-fluid" alt=""></div>
                        <div class="member-info">
                            <h4>Amanda Jepson</h4>
                    ...
                    <form  class="php-email-form">
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" v-model="formData.name" class="form-control" :class="{ 'is-invalid': errors.name }" id="name" required>
                                <div class="invalid-feedback" v-if="errors.name">{{ errors.name }}</div>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="email">Your Email</label>
                                <input type="email" v-model="formData.email" class="form-control" :class="{ 'is-invalid': errors.email }" id="email" required>
                                <div class="invalid-feedback" v-if="errors.email">{{ errors.email }}</div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="subject">Subject</label>
                            <input type="text" v-model="formData.subject" class="form-control" :class="{ 'is-invalid': errors.subject }" id="subject" required>
                            <div class="invalid-feedback" v-if="errors.subject">{{ errors.subject }}</div>
                        </div>
                        <div class="form-group">
                            <label for="message">Message</label>
                            <textarea v-model="formData.message" class="form-control" :class="{ 'is-invalid': errors.message }" id="message" rows="10" required></textarea>
                        ...
                        <div class="text-center">
                            <button type="button" @click="submitForm">Send Message</button>
                        </div>
                    </form>
                </div>
...
export default {
    ...
    mounted() {
        ...
        this.headerScrolled(); // Call initially
    ...
    methods: {
        headerScrolled() {
            let selectHeader = document.getElementsByTagName('header')[0];
            if (selectHeader) {
        ...
        submitForm() {
            ...
            // Submit form
            this.loading = true;
            // You can now submit the form data to your backend using fetch or axios
            // Example:
            fetch('/api/contectEmail', {
                    method: 'post',
